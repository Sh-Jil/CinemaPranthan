                    ...
                    return <Widget>[
                      SliverAppBar(
                        ...
                        flexibleSpace:
                          ...
                          return BlocBuilder<TvSeasonDetailBloc,
                              TvSeasonDetailState>(
                            builder: (context, state) {
                              return state.isLoading
                                  ? const Center(
                  ...
                  body: BlocBuilder<TvSeasonDetailBloc, TvSeasonDetailState>(
                    builder: (context, state) {
                      return CustomScrollView(
                        ...
                        slivers: [
                          SliverToBoxAdapter(
                              child: state.seasondetail.isNotEmpty
                                  ? Column(
                                      crossAxisAlignment:
                                      ...
                                      children: [
                                        ...
                                        if (state.seasondetail[0].overview
                                            .isNotEmpty)
                          ...
                          SliverList(
                            delegate:
                              ...
                              return BlocBuilder<TvSeasonDetailBloc,
                                ...
                                builder: (context, state) {
                                  return state
                                          .seasondetail[0].episodes!.isNotEmpty
                                      ? Padding(
                                          padding: const EdgeInsets.symmetric(
                                          ...
                                          child: ListView.separated(
                                                ...
                                                return EpisodeTile(
                                                    date: head.airDate !=
                                                        ...
                                                        ? dateformating(
                                                            head.airDate)
                                                        : "_",
                                                    imageurl: head.stillPath !=
                                                            null
                                                        ? "$backdrophead${head.stillPath}"
                                                        : "",
                                              ...
                                              separatorBuilder:
                                                  (context, index) =>
                                                      const Divider(),
                                              itemCount: state.seasondetail[0]
                                                  .episodes!.length),
                                        )
                                      : const SizedBox();
                                },
                          ...
                          SliverList(
                              delegate: SliverChildBuilderDelegate(
                                  ((context, index) => BlocBuilder<
                                          SeasonCreditsBloc, CastCrewState>(
                                        builder: (context, state) {
                                          return state.isLoading
                                              ? const Center(
                                                  child:
